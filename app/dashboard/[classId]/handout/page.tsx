  ...
  return (
    <main className="min-h-screen bg-bgSage print:bg-white">
      ...
      <div className="print:hidden max-w-2xl mx-auto flex items-center justify-between px-6 pt-8">
        <Link href={`/dashboard/${cls.id}/roster`} className="text-sm text-textTitle/65 hover:text-textTitle">← Back to roster</Link>
        <button
      ...
      <div className="max-w-2xl mx-auto px-6 py-8 print:py-0">
        <div className="bg-white rounded-3xl shadow-sm print:shadow-none print:rounded-none p-10 text-center">
          ...
          <p className="text-textTitle/65 text-sm mb-8">Free financial-literacy lessons for your class.</p>

          {cls.joinCode ? (
            <div className="mb-8">
              <div className="text-xs uppercase tracking-wider text-textTitle/65 mb-2">Class code</div>
          ...
          <div className="text-left max-w-sm mx-auto">
            <div className="text-xs uppercase tracking-wider text-textTitle/65 mb-3">How to join</div>
          ...
          {cls.students.length > 0 && (
            <div className="text-left mt-10 pt-6 border-t border-textTitle/10">
              <div className="text-xs uppercase tracking-wider text-textTitle/65 mb-2">Already joined ({cls.students.length})</div>
