      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-6">
        ...
        <aside className="w-full lg:w-72 shrink-0 order-1">
          <div className="lg:sticky lg:top-28 bg-white rounded-3xl shadow-sm p-5">
            ...
            <div className="text-[11px] font-semibold tracking-wider text-textTitle/70 uppercase mb-2">My progress</div>
            ...
            <div className="text-xs text-textTitle/70 mb-5">{pct}% complete</div>

            <div className="text-[11px] font-semibold tracking-wider text-textTitle/70 uppercase mb-1">Menu</div>
