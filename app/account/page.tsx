  ...
  return (
    <main className="min-h-screen bg-bgSage pt-28 pb-16 px-4">
      <div className="max-w-xl mx-auto">
        <button onClick={() => router.push('/dashboard')} className="text-sm text-textTitle/70 hover:text-textTitle">← Dashboard</button>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 space-y-5">
          ...
          {msg && <p className="text-sm text-textTitle/70">{msg}</p>}
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mt-4 flex items-center justify-between gap-4">
          <div>
            ...
            <div className="text-xs text-textTitle/70">We’ll email you a reset link.</div>
          </div>
